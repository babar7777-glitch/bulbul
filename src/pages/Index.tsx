    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main id="main-content" className="flex-1">
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center animate-fade-in">
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Discover the joy of creating beautiful art with our curated DIY kits. Each kit includes everything you need plus step-by-step video tutorials.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button asChild size="lg" className="text-lg px-8">
                  <Link to="/shop">Shop Kits <ArrowRight className="ml-2 h-5 w-5" /></Link>
                </Button>
        ...
        <section className="py-12 md:py-16 bg-background">
          <div className="container mx-auto px-4">
            <h2 className="font-heading text-3xl md:text-4xl text-center text-foreground mb-12">Why DIY with BulBul?</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center p-6 rounded-2xl bg-muted/50 animate-fade-in">
                ...
                <p className="text-muted-foreground text-base">Unwind and destress while creating something beautiful with your hands.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-muted/50 animate-fade-in" style={{ animationDelay: "0.1s" }}>
                ...
                <p className="text-muted-foreground text-base">Experience the joy and satisfaction of making art you'll love.</p>
              </div>
              <div className="text-center p-6 rounded-2xl bg-muted/50 animate-fade-in" style={{ animationDelay: "0.2s" }}>
                ...
                <p className="text-muted-foreground text-base">Create stunning pieces that add a personal touch to your space.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              <h2 className="font-heading text-3xl md:text-4xl text-center text-foreground mb-4">What's in Every Kit?</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-base">Quality supplies, brushes, paints, and everything you need to complete your project.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-base">Step-by-step instructions with helpful tips and techniques.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-base">Follow along with our detailed video guides at your own pace.</p>
                  </div>
                </div>
                <div className="flex items-start gap-4 p-4 bg-card rounded-xl border border-border">
                  <div className="w-10 h-10 bg-secondary rounded-lg flex items-center justify-center flex-shrink-0">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-base">Join our community of creators and share your finished pieces!</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <section className="py-12 md:py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="flex items-center justify-between mb-12">
              <h2 className="font-heading text-3xl md:text-4xl text-foreground">Featured Kits</h2>
            ...
            {loading ? (
              ...
              <div className="text-center py-12 bg-muted/30 rounded-2xl">
                ...
                <p className="text-muted-foreground text-base">Products will appear here once connected to Shopify!</p>
              </div>
            )}
          </div>
        </section>
        ...
        <section className="py-12 md:py-16 bg-gradient-to-r from-primary to-secondary text-primary-foreground">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-primary-foreground/90 text-lg mb-8 max-w-2xl mx-auto">Browse our collection of DIY art kits and find your next creative project.</p>
